\documentclass[hyperref={colorlinks=true,filecolor=blue,linkcolor=blue,urlcolor=blue},aspectratio=169]{beamer}
...
\newmintedfile{python}{fontsize=\scriptsize, xleftmargin=12pt}
...
\newminted{ipythonconsole}{fontsize=\footnotesize, xleftmargin=12pt}

\input{creative_commons/cc_beamer}

\author{Valentin Haenel}
\institute{Senior Software Engineer - Open Source / Numba \\
\url{https://anaconda.com}}

\title{Regularizing Python using Structured Control Flow}
\definecolor{gray}{rgb}{0.10,0.10,0.10}
\date{29 Aug 2024 -- EuroScipy -- Maritime University of Szczecin}
...
\begin{frame}
    ...
    \hspace{1em}
    \tiny\url{https://github.com/esc/numba-scfg-talk}
    \begin{tabular}[t]{lr}
